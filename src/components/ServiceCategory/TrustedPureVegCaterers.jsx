...
function TrustedPureVegCaterers() {
  ...
  const handlePortfolio = (portfolioId) => {
    navigate(`/portfolio/${serviceId}/${portfolioId}`);
  };
  ...
  return (
    <section className="w-full bg-white px-4 py-9 sm:px-6 sm:py-10 md:px-8 md:py-11 lg:px-10 lg:py-12">

      {/* ================= HEADING ================= */}

      <div className="mb-8 text-center sm:mb-9 md:mb-10 lg:mb-10">
        <h2 className="text-[21px] font-medium leading-tight tracking-normal text-[#252525] sm:text-[22px] md:text-[23px] lg:text-[25px]">
      ...
      <div className="relative mx-auto w-full max-w-[1240px]">
        ...
        <div className="grid grid-cols-1 gap-7 sm:grid-cols-2 sm:gap-7 lg:grid-cols-3 lg:gap-9">
