  ...
  return (
    <div className="w-full overflow-hidden rounded-[8px] border border-gray-300 bg-white shadow-sm md:w-[95%]">
      ...
      <div className="flex h-[39px] items-center justify-between border-b border-gray-200 bg-white px-[13px]">
        ...
        <h2 className="text-[15px] font-semibold uppercase tracking-[0.1px] text-[#171717]">
      ...
      <div className="relative h-[200px] bg-white">
        ...
        <p className="absolute left-0 right-0 top-[10px] px-4 text-center font-light text-[15px] leading-[13px] text-[#555]">
          Manage the badge text in the landing page thumbnail previews.
        </p>

        <button
          type="button"
          className="absolute bottom-[12px] left-1/2 -translate-x-1/2 bg-transparent text-[15px] font-semibold text-[#333] underline"
        >
          Edit
        </button>
